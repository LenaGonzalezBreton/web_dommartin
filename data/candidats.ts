...
export const candidats: Candidate[] = [
    {
        ...
        role: "Tête de liste",
        bio: `Natif de Dommartin, je suis âgé de 68 ans et je réside à Franould. Je suis marié, père de deux enfants et grand père de deux petits-enfants. J’ai exercé pendant 40 ans le métier d’agriculteur au village.

Professionnellement, j’ai également assuré des responsabilités importantes tant au niveau départemental  que national. Etant sportif, j’ai initié la randonnée VTT des Picosés en partenariat avec la MJC et j’en ai tracé les circuits en forêt pendant près de 20 ans. 

Depuis ma retraite, je m’investis dans une association qui accompagne des agriculteurs en difficultés, et, au sein de notre commune, je suis président du Comité d’Accueil Vermeil qui organise le repas annuel et la distribution des colis pour les ainés.

J’ai toujours été intéressé par la vie municipale et j’ai exercé un mandat de conseiller de 2014 à 2020.

Profondément convaincu qu’un maire doit être à l’écoute de ses concitoyens, qu’une municipalité doit être ouverte et transparente dans sa gestion, j’ai accepté de conduire la liste « Dommartin avec vous », dans le respect de ces valeurs, avec une équipe compétente qui réunit des profils issus d’horizons variés, engagés dans la vie associative et professionnelle locale.

Nous nous attacherons à construire pour vous et avec vous un projet municipal correspondant à la feuille de route établie lors de nos réunions participatives.

Si vous nous accordez votre confiance, je m’engage à mettre mon expérience et mon énergie au service de notre beau village.`,
        photoUrl: "/jean-jacques-rosaye.jpg",
        isVisible: true,
    },
    {
        id: "2",
        name: "Marie Breton",
        role: "Co-listière",
        bio: `« Je veux une commune plus proche, plus à l’écoute, qui agit avec simplicité et efficacité, au quotidien. »

MON PARCOURS EN BREF
Vosgienne d’origine, j’ai occupé des responsabilités d’élue locale pendant près de 20 ans, dont première adjointe, et je suis vice-présidente d’un syndicat d’énergie. À mon retour à Dommartin, où je rejoignais mon compagnon Jean-François Danzon, j’ai eu envie de « remettre les mains dans le concret » : coup de main au Comité Vermeil (repas des aînés, colis de Noël), engagement au CESER Grand Est et au comité syndical du Parc naturel régional des Ballons des Vosges.

POURQUOI JE M’ENGAGE
Parce que j’aime Dommartin et que je crois à une mairie accessible : une mairie qui répond, qui explique et qui avance. Je veux apporter une présence, une méthode, et une énergie tournée vers les solutions.

MES PRIORITÉS POUR DOMMARTIN
• Communication et participation : Mieux informer (site, bulletins, réunions), associer les habitants quand c’est possible, et rendre compte de façon lisible.

• Bien vivre & cadre de vie : Entretien programmé, réactivité, amélioration du quotidien et valorisation de ce qui fait l’identité de Dommartin.

• Forêt & environnement, avec une gestion financière saine : Protéger et valoriser la forêt, agir pour l’environnement, et piloter les investissements avec rigueur : choix assumés, budget maîtrisé, subventions recherchées.

UNE ANECDOTE / UN TRAIT PERSONNEL
Si vous me cherchez, vous me trouverez souvent dehors : la nature est mon équilibre… et une vraie richesse à préserver ici.`,
        photoUrl: "/marie-breton.jpg",
        isVisible: true,
    },
    {
        id: "3",
        ...
        role: "Co-listier",
        bio: `« Je crois en une commune à l’écoute, solidaire et dynamique, construite avec et pour vous. »

Je m’appelle Christophe Impéradori, j’ai 58 ans et je vis à Dommartin les Remiremont depuis maintenant 25 ans.
Dommartin les Remiremont, ce n’est pas seulement un lieu de résidence pour moi : c’est un territoire que j’ai vu évoluer, dans lequel j’ai élevé mes trois enfants, et auquel je suis profondément attaché.

Depuis plus de 15 ans, je suis engagé dans la vie associative de notre commune, en tant que président d’association. Cet engagement m’a appris à écouter, à rassembler, à gérer des projets concrets et à travailler avec des bénévoles, des partenaires et les institutions locales.

Être assidu dans l’associatif, c’est être au plus près des réalités du quotidien : les attentes des familles, les besoins des jeunes, les préoccupations des aînés. C’est agir, souvent discrètement, mais toujours avec constance et sens des responsabilités.

Aujourd’hui, si je m’engage, c’est avec la volonté de mettre cette expérience, cette connaissance du terrain et cette énergie au service de l’ensemble des habitants de Dommartin les Remiremont.`,
        photoUrl: "/christophe-imperadori.jpg",
        isVisible: true,
    },
    {
        id: "4",
        name: "Valérie Virion",
        role: "Co-listière",
        bio: `« Mon engagement est guidé par une conviction simple : Agir pour que chaque habitant trouve sa place dans notre commune. »

Je m’appelle Valérie Virion, j’ai 58 ans, 2 enfants et j’habite Dommartin les Remiremont depuis 20 ans.
J’exerce la profession de Cadre de santé en EHPAD à Vagney où je me consacre au bien être des personnes âgées depuis 26 ans.

Dommartin représente pour moi un village convivial offrant une qualité de vie agréable, c’est pourquoi je souhaite m’engager dans la vie municipale afin de contribuer à l’amélioration du quotidien de chacun.
Je souhaite mettre mon énergie au service d’une commune où l’on se connait, s’entraide et s’épanouit.

MA PRIORITÉ
Accompagner votre quotidien par la proximité, l’écoute et le dialogue.
Favoriser les liens sociaux et intergénérationnels.`,
        photoUrl: "/valerie-virion.jpg",
        isVisible: true,
    },
    {
        id: "5",
        name: "René Sehr",
        role: "Co-listier",
        bio: `« Nous sommes tous des Picosés, vivons bien et faisons tout pour vivre mieux et en harmonie. »

René SEHR : 70 ans - Marié 2 enfants et 2 petits-enfants
J'habite à Franould – Rue de la Plaine

L’enjeu des prochaines élections municipales, temps fort démocratique, est une occasion de m’engager au service des habitants du village où je réside depuis une vingtaine d’années.

Retraité de la gendarmerie, j’ai exercé en France métropolitaine mais aussi Outre-Mer et à l’étranger ; une carrière complète consacrée au service des citoyens avec le sens du devoir, courage et humanité.

Doté de ces valeurs, homme de bon sens , disponible et déterminé je souhaite m’impliquer dans une équipe unie pour un travail sérieux et agir en toute transparence sans être coupé des réalités et des contraintes.`,
        photoUrl: "/rene-sehr.jpg",
        isVisible: true,
    },
    {
        id: "6",
        name: "Caroline Moret",
        role: "Co-listière",
        bio: `« Je souhaite m’investir avec curiosité, enthousiasme et bonne humeur, pour être utile et agir concrètement pour notre village. »

Je suis Caroline Moret, 61 ans, originaire de Remiremont. Après une carrière qui m’a parfois menée loin des Vosges, je reviens dans ma région avec le statut de retraitée des fonctions publiques territoriales et d’État. Aujourd’hui, j’ai envie de soutenir concrètement les projets de ma commune et de prendre part à sa vie locale.

Installée depuis un an à Dommartin-lès-Remiremont, dans le hameau de La Poirie, je souhaite mettre mon énergie et mes compétences au service du village. Je veux collaborer avec celles et ceux qui contribuent à son dynamisme, à son développement et à son futur.
